...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/ZooAssignment/public/AdminHome" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/ZooAssignment/public/AdminHome" class="brand-link text-center">
      <img src="/ZooAssignment/public/resources/images/logo.jpg" alt="Claybrook Zoo Heading" class="brand-image img-circle elevation-3"
           style="opacity: .8">
